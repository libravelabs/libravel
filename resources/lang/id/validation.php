...
return [
    ...
    */
    ...
    'contains' => 'Kolom :attribute kehilangan nilai yang dibutuhkan.',
    ...
    'lte' => [
        ...
        'string' => 'Kolom :attribute tidak boleh lebih besar dari :value karakter.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'Kolom :attribute yang diberikan telah muncul dalam kebocoran data. Harap pilih :attribute yang lain.',
    ],
    ...
    | menggunakan konvensi "atribut.aturan" untuk menamai barisnya. Ini membuatnya cepat
    ...
    */
    ...
    'custom' => [
        'rating' => [
            ...
            'min' => 'Rating harus minimal 0.5.',
            'max' => 'Rating harus maksimal 5.',
        ],
        'reviewText' => [
            'min' => 'Ulasan minimal 3 karakter.',
            'max' => 'Ulasan maksimal 1000 karakter.',
        ],
    ],
    ...
    | dengan sesuatu yang lebih mudah dibaca seperti "Alamat E-Mail" alih-alih "email".
    | Ini hanya membantu membuat pesan kami lebih ekspresif.
    |
    */
